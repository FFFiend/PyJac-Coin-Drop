...
export const centerCurve = x => {
    // TODO
    return 128997 + -4792.72 * x + 79.2898 * (x ** 2) + -0.768078 * (x ** 3) + 0.00482271 * (x ** 4)
         + 0.0000205082 * (x ** 5) + 5.9822934 *(10 ** -8) * (x ** 6) + -1.182288 * (10 ** -8) * (x ** 7) + 1.5155 * (10 ** -13) * (x ** 8)
         + -1.138207 * (10 ** -16) * (x ** 9) + 3.8048 * (10 ** -20) * (x ** 10);
}
